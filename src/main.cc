...
NAN_METHOD(convert_blob_2) { // (parentBlockBuffer, cnBlobType)
     if (info.Length() < 1)
...
NAN_MODULE_INIT(init) {
    ...
    Nan::Set(target, Nan::New("convert_blob_2").ToLocalChecked(), Nan::GetFunction(Nan::New<FunctionTemplate>(convert_blob_2)).ToLocalChecked());
